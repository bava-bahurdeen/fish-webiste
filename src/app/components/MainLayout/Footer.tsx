      ...
      <div className="container mx-auto">
        ...
        <div className="grid place-items-center ">
          ...
          <ul className="flex gap-x-10 mt-10 items-center cursor-pointer">
            <li className="size-7 md:size-10 grid place-items-center rounded-full bg-white hover:scale-110 transition-all duration-300">
              <FaInstagram className="md:text-2xl font-semibold text-[#E1306C]" />
            </li>
            <li className=" size-7 md:size-10 grid place-items-center rounded-full bg-white  hover:scale-110 transition-all duration-300">
              <FaFacebook className="md:text-2xl font-semibold text-[#316FF6]" />
            </li>
            <li className=" size-7 md:size-10 grid place-items-center rounded-full bg-white  hover:scale-110 transition-all duration-300">
              <FaTwitter className="md:text-2xl font-semibold text-[#1DA1F2]" />
            </li>
            <li className=" size-7 md:size-10 grid place-items-center rounded-full bg-white  hover:scale-110 transition-all duration-300">
              <FaYoutube className="md:text-2xl font-semibold text-[#FF0000]" />
            </li>
          </ul>
